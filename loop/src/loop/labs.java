...
public class labs {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. Print a Boolean Expression:");
		...
		//				iv. If there are 5 or more cookies, print "Jackpot!"
			...
			int numberOfChildren=2;  //while this ariable?
			if (numberOfCookies == 0){
				System.out.println("Sad Face");
			}else if (numberOfCookies<2 ) {
				System.out.println("Yes");
			}else if (numberOfCookies>=2 && numberOfCookies<5) {
				System.out.println("Whoohoooooo!");
		...
		switch(loyaltyMemberStatus) {
			...
			case "PLATINIUM":
				...
				break;
			default:
				System.out.println("Loyalty Member Status error !!!");
		}
